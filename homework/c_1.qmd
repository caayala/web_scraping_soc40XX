...
Formato
: Desarrollar esta tarea en un Rmarkdown, agregando comentarios cuando sea necesario.
...
4) Agregar a la base de datos el dato `continente` para cada país según la base de datos [countryName_continent.csv](homework/c_1_files/countryName_continent.csv) disponible en el repositorio.
