...
Se pueden probar varios selectores [acá](https://www.w3schools.com/CSSref/trysel.asp) y probar las habilidades en [CSS Diner](https://flukeout.github.io)
...
Se debe saber como manejar distintas secciones de los datos.
...
Selección de todos los elementos con atributo `alt` que contenta la palabra *akita*
...
Selección en columna de categorías de clase `.side_categories` los links `<a>`:
