...
- Podemos entonces controlar un navegador sin cabeza (*headless browser*) para generar acciones y obtener los datos demandados.
]
...
.pull-left[
- La página es una vista de Google Maps con información georeferenciada de cada escuela.

- Datos de cada escuela se despliegan al momento de hacer click sobre su ubicación.

- Nuevas escuelas se cargan a medida que se dezplaza o agranda el mapa.
...
.pull-left[
- La información de una escuela se accesde mediante:
